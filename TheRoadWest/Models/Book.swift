...
let book = [
    // MARK:- Chapter 1
    Chapter(title: "Chapter 1", textItems: [
    // 0
        ...
        ScreenBuild(
            ...
            buttons: [
                ...
                Button(buttonText: "No", gameStateNumber: 0, actionGroup: "nextChapter"),
        ...
        ScreenBuild(
            ...
            buttons: [
                ...
                Button(buttonText: "Where's Waldo?", gameStateNumber: 3),
    ...
    """,
            buttons: [
                ...
                Button(buttonText: "Eat peas", gameStateNumber: 0),
    ...
    // MARK:- Chapter 3
    Chapter(title: "Chapter 3", textItems: [
    // 0
    ScreenBuild(
        textView: "3Welcome to the game! I will be your host. Please pay attention to the details you recieve here. \n\nDo you want to play?",
        buttons: [
            Button(buttonText: "Yes", gameStateNumber: 1, actionGroup: "gainFood"),
            Button(buttonText: "No", gameStateNumber: 0, actionGroup: "nextChapter"),
            Button(buttonText: "", gameStateNumber: 0),
